...
class HT_Line_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_h_t__line_, container, false)

        val thickness_editTextView : TextInputEditText = view.findViewById(R.id.ht_line_thickness_ETV)
        val material_type_editTextView : TextInputEditText = view.findViewById(R.id.ht_line_material_ETV)
        ...
        sendToDB_Btn.setOnClickListener {
            ...
            if (longitude != null && latitude != null) {
                ...
                if(response == "Success"){
                    ...
                    val sharedPreferences: SharedPreferences? = activity?.getSharedPreferences("HTLINE",
                    ...
                    editor!!.putString("H.T.Line"+unsave_items+1,"H.T.Line")
